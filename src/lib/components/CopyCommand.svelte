...
<div class="copy-command-wrapper {wrapperClass}" style="max-width: {maxWidth};">
	<div
	...
	<!-- Copied Indicator -->
	<div class="copied-indicator" class:show={showCopied} role="status" aria-live="polite">
		{copiedText}
	</div>
</div>
...
<style>
	...
	.copy-command {
		...
		scrollbar-color: var(--copy-scrollbar-thumb, var(--color-muted))
