...
<div class="max-w-5xl mx-auto mt-24 mb-20">
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
		{#each teamMembers as member}
			<div
				class="team-card bg-[var(--color-card)] border border-[var(--color-border)] p-8 rounded-xl text-center hover:border-[var(--color-primary)] transition-all duration-300"
			>
				<div
					class="w-24 h-24 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-accent)] rounded-full mx-auto mb-4 flex items-center justify-center"
				>
