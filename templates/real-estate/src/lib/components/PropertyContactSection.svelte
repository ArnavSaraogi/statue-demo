...
<section id="contact" class="py-32 px-4">
	<div class="max-w-7xl mx-auto">
			...
			<div class="max-w-4xl mx-auto mb-32 animate-on-scroll animate-fade-up">
				...
				<div class="grid md:grid-cols-2 gap-6 mb-12">
					{#each events as event, index}
						<div
							class="border border-[var(--color-border)] p-8 hover:border-[var(--color-primary)] transition-colors duration-300 relative"
						>
							...
							<button
								...
								class="cursor-pointer text-[var(--color-primary)] text-sm tracking-wide hover:underline underline-offset-4 transition-all flex items-center gap-2"
							>
							...
							{#if activeEventIndex === index}
								<div
									class="absolute left-0 right-0 top-full mt-2 bg-[var(--color-card)] border border-[var(--color-border)] shadow-xl z-10 animate-fade-in"
								>
									<button
										type="button"
										onclick={() => openGoogleCalendar(event)}
										class="cursor-pointer w-full px-4 py-3 text-left text-gray-300 hover:bg-[var(--color-border)] hover:text-white transition-colors flex items-center gap-3"
									>
										<svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
											<path
												d="M19.5 3h-15A1.5 1.5 0 003 4.5v15A1.5 1.5 0 004.5 21h15a1.5 1.5 0 001.5-1.5v-15A1.5 1.5 0 0019.5 3zm-6 13.5h-3v-3h3v3zm0-4.5h-3V9h3v3z"
											/>
										</svg>
										Google Calendar
									</button>
			...
			<div class="animate-on-scroll animate-fade-right">
				...
				<div class="flex flex-wrap gap-8 mb-10">
					{#if agentPhone}
						<a
							href="tel:{agentPhone}"
							class="flex items-center gap-3 text-gray-300 hover:text-[var(--color-primary)] transition-colors"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="18"
				...
				{#if Object.keys(agentSocial).length > 0}
					<div class="flex gap-4">
						{#if agentSocial.linkedin}
							<a
								href={agentSocial.linkedin}
								target="_blank"
								rel="noopener noreferrer"
								class="w-12 h-12 border border-[var(--color-border)] flex items-center justify-center text-white hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors"
								aria-label="LinkedIn"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
		...
		<div
			class="max-w-3xl mx-auto border-t border-[var(--color-border)] pt-24 animate-on-scroll animate-fade-up"
		>
			...
			<div class="grid md:grid-cols-3 gap-12 text-center">
				<div>
					...
					<a
						href="mailto:{email}"
						class="text-gray-300 hover:text-[var(--color-primary)] transition-colors">{email}</a
					>
				</div>
				<div>
				...
				<div class="flex justify-center gap-4 mt-12">
					...
					{#if social.youtube}
						...
						>
							...
							>
								<path
									d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.6 49.6 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.6 49.6 0 0 1-16.2 0A2 2 0 0 1 2.5 17"
								></path>
