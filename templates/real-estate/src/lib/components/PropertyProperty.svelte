			...
			<div class="mb-16">
				...
				<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
					{#each features as item, index}
						<div
							class="animate-on-scroll animate-fade-up h-full"
									...
									<div>
										...
										<div class="space-y-2 text-sm">
											{#if details.interior.bedrooms !== undefined}
												<div
													class="flex justify-between py-1 border-b border-[var(--color-border)]"
												>
											...
											{#if details.interior.hasFireplace !== undefined}
												...
												>
													...
													<span class="text-white"
														>{details.interior.hasFireplace ? 'Yes' : 'No'}</span
													>
												</div>
											{/if}
										</div>
									...
									<div>
										...
										<div class="space-y-2 text-sm">
											...
											{#if details.parking?.features && details.parking.features.length > 0}
												...
												>
													<span class="text-gray-400">Parking</span>
													<span class="text-white text-right text-xs"
														>{details.parking.features.join(', ')}</span
													>
												</div>
											{/if}
										</div>
										...
										<div class="space-y-2 text-sm">
											...
											{#if details.construction.homeType}
												...
												>
													...
													<span class="text-white text-right text-xs"
														>{details.construction.homeType}</span
													>
												</div>
											{/if}
										...
										<div class="space-y-2 text-sm">
											...
											{#if details.hoa?.hasHoa && details.hoa.fee}
												...
												>
													...
													<span class="text-white"
														>{details.hoa.fee}{details.hoa.frequency
															? `/${details.hoa.frequency}`
															: ''}</span
													>
												</div>
											{/if}
